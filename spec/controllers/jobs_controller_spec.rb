  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved job as @job" do
        ...
        post :create, {:job => { "company_id" => "invalid value" }}, valid_session
        assigns(:job).should be_a_new(Job)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested job" do
        ...
        Job.any_instance.should_receive(:update).with({ "company_id" => "1" })
        put :update, {:id => job.to_param, :job => { "company_id" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the job as @job" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Job.any_instance.stub(:save).and_return(false)
        put :update, {:id => job.to_param, :job => { "company_id" => "invalid value" }}, valid_session
        assigns(:job).should eq(job)
      end
